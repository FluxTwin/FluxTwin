...
def generate_pdf(path, project_name, stats, ai_summary, chart_png_bytes=None, daily_rows=None, logo_png_path=None):
    ...
    story.append(Spacer(1, 6))
    # Convert bullets safely
    clean = ai_summary.replace("\n•", "<br/>•").replace("\n- ", "<br/>• ")
